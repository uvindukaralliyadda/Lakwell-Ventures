...
const Projects = () => {
  return (
    <motion.div  className='projects' id='projects' initial={{ opacity: 0 }} whileInView={{opacity: 1 }} transition={{ duration: 1 }}>
      ...
      <div  className='project-images'>
                  <motion.div  className='project-article' initial={{ opacity: 0 }} whileInView={{opacity: 1 }} transition={{ duration: 1 }}>
                      <img src={hospitality}/>
